...
import 'package:eazy_rent/screens/places/placesnot/placesnot.dart';
import 'package:flutter/material.dart';
import 'package:intl/intl.dart';
import 'package:provider/provider.dart';
import '../branded/brandednot/brandednot.dart';
import '../logged-signup/login.dart';
import '../providers/chartdetail.dart';
import '../screens/all/all.dart';
import '../screens/all/allnot/allnot.dart';
import '../screens/category/cart.dart';
import '../screens/category/catnot/cartnot.dart';
import '../screens/deals/deal.dart';
import '../screens/deals/dealsnot/dealnot.dart';
import '../screens/deals/dealsnot/deldetanot.dart';
import '../screens/housedetails.dart';
import '../screens/places/places.dart';
import '../screens/places/placesnot/placesdetailsnot.dart';
import '../screens/slider/sliderlogged.dart';
import 'package:http/http.dart' as http;

import '../screens/slider/slidernot/slidernot.dart';



class Homenot extends StatefulWidget {
  static const  String id='home-not';

  @override
  State<Homenot> createState() => _HomenotState();
}

class _HomenotState extends State<Homenot> with TickerProviderStateMixin{
                          ...
                          InkWell(
                            onTap: (){
                              ...
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => DealdetailsNot(
                                    ),
                                  )
                              );
              ...
              Container(
                ...
                child:Column(
                  ...
                  children:  [
                          ...
                          InkWell(
                              onTap: (){
                                ...
                                Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (context) => PlacesDetailsNot(
                                      ),
                                    )
                                );
                    ...
                    const Flexible(child: PlacesNot()),
                  ],
                ),
              ),
                  ...
                  return InkWell(
                    onTap: (){
                      ...
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) =>  HouseDetailsNot(id:lists['ID'],userID:lists['user_id'],own:lists['owner'],
