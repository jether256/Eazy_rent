...
List< BanaModel> userFromJson(String str) => List< BanaModel>.from(json.decode(str).map((x) =>  BanaModel.fromJson(x)));

String userToJson(List< BanaModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
