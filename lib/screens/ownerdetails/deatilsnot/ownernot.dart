...
class OwnerDetailsNot extends StatefulWidget {
  ...
  OwnerDetailsNot({ required this.id, required this.userID, required this.own, required this.fon, required this.biz, required this.bizphon, required this.mail, required this.im1, required this.im2, required this.im3, required this.im4, required this.im5, required this.tit, required this.pr, required this.desc, required this.adu, required this.lat, required this.lon, required this.place, required this.bed, required this.bath, required this.fun, required this.con, required this.sq, required this.cs, required this.flo, required this.kit, required this.paid, required this.start, required this.end, required this.blocked, required this.type, required this.proid});




  @override
  State<OwnerDetailsNot> createState() => _OwnerDetailsNotState();
}

class _OwnerDetailsNotState extends State<OwnerDetailsNot> {
  ...
  Future openBox() async{
    ...
    Hive.init(dir.path);
    box=await Hive.openBox('ownernot');
    return;
  }
  ...
  Future   getHouses()async {
    ...
    try{
      ...
      var response = await http.post(Uri.parse("https://www.eazyrent256.com/api/user/banner/bannad.php"),
          headers:{"Accept":"headers/json"},body:{'uid':widget.userID});
