...
import 'dart:convert';
class DealdetailsNot extends StatefulWidget {
  const DealdetailsNot({Key? key}) : super(key: key);

  @override
  State<DealdetailsNot> createState() => _DealdetailsNotState();
}

class _DealdetailsNotState extends State<DealdetailsNot> {




  final StreamController<List> _streamController99 = StreamController<List>();
  Timer? _timer;
  ...
  Future openBox() async{
    ...
    Hive.init(dir.path);
    box=await Hive.openBox('dealnotdetail');
    return;
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar:AppBar(
        ...
        title:  Text('Deals',style: const TextStyle(color: Colors.white),),
        actions: [
          ...
          child: Container(
            ...
            child:Padding(
              ...
              child: StreamBuilder<List>(
                stream: _streamController99.stream,
                    ...
                    if(snapshot.data.length == 0) {
                      return Center(
                        child: Column(
                          ...
                          children: [
                            const Center(child: Text('There no deals')),
                          ],
                        ),
                      );
                    }
