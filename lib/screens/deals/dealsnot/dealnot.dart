...
class DealNot extends StatefulWidget {
  const DealNot({Key? key}) : super(key: key);

  @override
  State<DealNot> createState() => _DealNotState();
}

class _DealNotState extends State<DealNot> {
  ...
  Future openBox() async{
    ...
    Hive.init(dir.path);
    box=await Hive.openBox('dealnot');
    return;
  }
