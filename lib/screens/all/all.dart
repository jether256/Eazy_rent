...
class AllHoses extends StatefulWidget {
  const AllHoses({Key? key}) : super(key: key);

  @override
  State<AllHoses> createState() => _AllHosesState();
}

class _AllHosesState extends State<AllHoses> {
