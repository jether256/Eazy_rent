...
class DeatilCart extends StatefulWidget {
  final String ID;
  final String NAME;
  final String PIC;

   DeatilCart({ required this.ID, required this.NAME, required this.PIC});

  @override
  State<DeatilCart> createState() => _DeatilCartState();
}

class _DeatilCartState extends State<DeatilCart> {
