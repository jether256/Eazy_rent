...
import '../../all/allnot/allnot.dart';
import 'dart:convert';

class BannerDetailsNot extends StatefulWidget {
  ...
  final String end;
  final String paid;
  BannerDetailsNot({ required this.id, required this.User_id, required this.biz, required this.tit, required this.image, required this.start, required this.end, required this.paid});

  @override
  State<BannerDetailsNot> createState() => _BannerDetailsNotState();
}

class _BannerDetailsNotState extends State<BannerDetailsNot> {
  ...
  Future openBox() async{
    ...
    Hive.init(dir.path);
    box=await Hive.openBox('banadetailnot');
    return;
  }
