...
class PlacesNot extends StatefulWidget {
  const PlacesNot({Key? key}) : super(key: key);

  @override
  State<PlacesNot> createState() => _PlacesNotState();
}

class _PlacesNotState extends State<PlacesNot> {
  ...
  Future openBox() async{
    ...
    Hive.init(dir.path);
    box=await Hive.openBox('placesnot');
    return;
  }
